  ...
  return (
    ...
    >
      ...
      <div
        className={
          center
            ? "hex-center flex flex-col justify-center items-center bg-yellow-300"
            : "hex-middle flex flex-col justify-center items-center bg-zinc-200"
        }
      >
        {shuffling && !center ? (
          <h2 className="text-2xl font-bold fade-out duration-100">{letter}</h2>
        ) : (
          letter && (
